  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        <div className="absolute -bottom-12 -left-12 md:-bottom-20 md:-left-20 w-8 h-8 border-l border-b border-white/20" />
        <div className="absolute -bottom-12 -right-12 md:-bottom-20 md:-right-20 w-8 h-8 border-r border-b border-white/20" />
        ...
        >
          <motion.button
            ...
            className="group px-8 py-4 bg-white text-black text-sm font-medium flex items-center gap-3 hover:bg-neutral-200 transition-colors"
          >
            View Projects
